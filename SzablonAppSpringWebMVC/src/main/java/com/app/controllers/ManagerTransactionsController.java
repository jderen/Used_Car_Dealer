...
public class ManagerTransactionsController {
    ...
    public ManagerTransactionsController(EmployeeDao employeeDao, CarDao carDao, ClientDao clientDao, TransactionDao transactionDao) {
    ...
    public String addTransaction(@ModelAttribute TransactionDto transactionDto) {
        ...
        try {
            ...
            return "redirect:/myManager/transactions";
        }
    ...
    public String updateTransaction(@PathVariable Long id, Model model){
        ...
        return "/manager/updateTransaction";
    }
